    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <section className="mt-8 space-y-8 rounded-3xl border bg-white p-7 text-gray-700 sm:p-10">
          ...
          <div><h2 className="text-2xl font-bold text-[#123E52]">4. Shipping</h2><p className="mt-3 leading-7">RoxanneJoiner currently ships across the United States only. Orders normally require 1-2 business days for processing after payment confirmation, followed by 5-9 business days in standard U.S. transit after dispatch. Current coverage, shipping cost, address requirements, and tracking information are stated in our <Link href="/shipping-policy" className="font-semibold text-[#123E52] underline">Shipping Policy</Link>. Delivery dates are estimates unless expressly stated otherwise.</p></div>
          <div><h2 className="text-2xl font-bold text-[#123E52]">5. Returns and refunds</h2><p className="mt-3 leading-7">Returns are accepted by mail within 30 days for both defective and non-defective products when returned new only. Exchanges are accepted, the return label is included in the package, there is no restocking fee, and approved refunds are processed within 5 business days as stated in our <Link href="/return-policy" className="font-semibold text-[#123E52] underline">Return & Refund Policy</Link>.</p></div>
