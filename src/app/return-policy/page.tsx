...
export const metadata: Metadata = {
  title: 'Return & Exchange Policy | RoxanneJoiner',
  description:
    'RoxanneJoiner Return & Exchange Policy. We accept returns for both defective and non-defective products within 30 days. Free return label included, no restocking fee, 5-day refund processing.',
};
...
export default function ReturnPolicyPage() {
  const schemaMarkup = {
    ...
    'hasMerchantReturnPolicy': {
      ...
      'name': 'RoxanneJoiner Return & Exchange Policy',
      'merchantReturnLink': 'https://roxannejoiner.com/return-policy',
