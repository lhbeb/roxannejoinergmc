...
const ShippingInfo: React.FC<ShippingInfoProps> = ({ className = '', targetMarket }) => {
  ...
  return (
    <div className={`overflow-hidden rounded-[24px] border border-[#123E52]/15 bg-white ${className}`}>
      <div className="grid grid-cols-1 divide-y divide-[#123E52]/10 md:grid-cols-3 md:divide-x md:divide-y-0">
        <div className="px-5 py-5 sm:px-6">
          <div className="flex items-start gap-3">
            <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-2xl bg-[#F7F3E8] text-[#123E52]">
              <MapPin className="h-4 w-4" />
            </div>
            <div className="min-w-0">
              <p className="text-sm font-medium text-gray-500">Ships from</p>
              <p className="mt-1 text-sm font-semibold text-[#123E52]">
        ...
        <div className="px-5 py-5 sm:px-6">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm font-semibold text-[#123E52]">1-2 day processing + 5-9 day transit</p>
        ...
        <div className="px-5 py-5 sm:px-6">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm text-[#397F86] font-medium">By mail, new-only condition</p>
            </div>
          </div>
        </div>
      </div>
