      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mb-4 text-[#FAF6EB]/90 text-sm leading-relaxed">
              RoxanneJoiner is a premier golf cart brand dedicated to manufacturing exceptional electric, luxury, and street-legal golf carts designed for comfort, power, and everyday convenience.
            </p>
            <div className="space-y-2.5 text-sm">
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:contact@roxannejoiner.com" className="hover:text-white hover:underline transition-colors duration-200">
              ...
              <div className="pt-2 flex gap-3">
                <a
                  href="https://www.tiktok.com/@roxannejoiner_officiel"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={socialIconClass}
                  aria-label="Follow RoxanneJoiner on TikTok"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className={socialIconClass}
                  aria-label="Follow RoxanneJoiner on Instagram"
                >
                  <Instagram className="h-4 w-4" />
                </a>
                <a
                  href="https://www.pinterest.com/RoxanneJoiner_official/_pins/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={socialIconClass}
                  aria-label="Follow RoxanneJoiner on Pinterest"
                >
        ...
        <div className="border-t border-white/15 mt-12 pt-8">
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-center text-xs sm:text-sm text-[#FAF6EB]/70">© 2025 RoxanneJoiner. All rights reserved. roxannejoiner.com</p>
          </div>
        </div>
      </div>
    </footer>
